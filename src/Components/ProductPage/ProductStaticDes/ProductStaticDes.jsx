...
import "../ProductDes/ProductDes.css";
import Data from "./StaticProductData.json";

function ProductStaticDes() {
  return (
    <div>
      ...
      <div class="card-wrapper">
        <div class="card">
          <div class="product-imgs">
            <div class="img-display">
              <div class="img-showcase">
                <img
                  className="object-cover w-full lg:h-1/2"
                  src="https://wakefitdev.gumlet.io/img/mattresslifestyle/ortho_01.jpg?w=1700"
                  alt=""
                />
              </div>
            </div>
          ...
          <div class="product-content">
            <h2 class="product-title">{Data[0][0].title}</h2>
            ...
            <div class="product-detail">
              ...
              <ul>
                <li>
                  Comfort Layer : <span>{Data[0].comfort_layer}</span>
                </li>
                <li>
                  Base Layer : <span>{Data[0].comfort_layer}</span>
                </li>
                <li>
                  Dimension : <span>All sizes available</span>
                </li>
                <li>
                  Thikness : <span>All sizes available</span>
                </li>
                <li>
                  Firmness Level : <span>8 level</span>
                </li>
              </ul>
            </div>
...
export default ProductStaticDes;
